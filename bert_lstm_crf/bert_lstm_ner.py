...
if os.name == 'nt':
    ...
    root_path = r'C:\Users\hhtdl\Desktop\BERT\Name-Entity-Recognition-master\BERT-BiLSTM-CRF-NER'
else:
    bert_path = '/home/ugrad/HaotianHu/BERT/bert_lstm_crf/uncased_L-12_H-768_A-12'
    root_path = '/home/ugrad/HaotianHu/BERT/bert_lstm_crf'

flags.DEFINE_string(
    "data_dir", os.path.join(root_path, 'Abs_data'),
    "The input datadir.",
)
...
flags.DEFINE_string(
    "output_dir", os.path.join(root_path, 'output/hhhh'),
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["B-I", "I-I", "E-I", "B-M", "I-M", "E-M", "B-R", "I-R", "E-R", "B-D", "I-D", "E-D", "B-RD", "I-RD", "E-RD", "X", "[CLS]", "[SEP]"]
    ...
    for i, word in enumerate(textlist):
        ...
        if 'E-' in label_1:
            for m in range(len(token)):
                if m != len(token)-1:
                    labels.append(label_1.replace('E-', 'I-'))
                else:
                    labels.append(label_1)
        else:
            for m in range(len(token)):
...
#         raise ValueError("At least one of `do_train` or `do_eval` must be True.")
    ...
    FLAGS.data_config_path = os.path.join(FLAGS.output_dir, 'data.conf')
